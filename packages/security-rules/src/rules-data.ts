...
export const ACTIVE_RULES: ISecurityRule[] = [
  ...
  },
  {
    ...
    description: 'The application may make requests to arbitrary URLs supplied by the user.',
    ...
    remediation: 'Validate and sanitize URLs against an allowlist. Block internal IP addresses.',
